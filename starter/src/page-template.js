...
const generateTeam = (team) => {
  ...
  const generateManager = (manager) => {
    return `
        ...
        <div class="card-header bg-info">
            ...
            <h3 class="card-title text-white"><i class="fas fa-mug-hot mr-2 text-warning"></i>${manager.getRole()}</h3>
        </div>
  ...
  const generateEngineer = (engineer) => {
    ...
    <div class="card-header bg-info">
        ...
        <h3 class="card-title text-white"><i class="fas fa-glasses mr-2 text-warning"></i>${engineer.getRole()}</h3>
    </div>
    <div class="card-body bg-light">
        <ul class="list-group">
  ...
  const generateIntern = (intern) => {
    ...
    <div class="card-header bg-info">
        ...
        <h3 class="card-title text-white"><i class="fas fa-user-graduate mr-2 text-warning"></i>${intern.getRole()}</h3>
    </div>
    <div class="card-body bg-light">
        <ul class="list-group">
